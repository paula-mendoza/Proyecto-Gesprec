<%-- 
    Document   : show
    Created on : 6/05/2020, 07:39:41 AM
    Author     : Dell_1
--%>
...
<html>
    <head>
        ...
        <title>Jshow Data</title>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary" >
            <a class="navbar-brand" href="#">ROL</a>
        ...
        <table class="table">
            ...
            <tbody>
                <c:forEach var="rol" items="${list}">
                    <tr>
                        <th scope="row"><c:out value="${rol.id}" /></th>
                        <td><c:out value="${rol.nombre}" /></td>
                        
                        <td><a href="">Update</a></td>
                        <td><a href="">Delete</a></td>
                        <td><a href="RolServlet?action=delete&id">Delete</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
